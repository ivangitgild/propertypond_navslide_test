...
var MultiUnit = Object.create(ListingModel); 

// Set the resource that applies to this model
MultiUnit.resource = 'Multi';
MultiUnit.originalResource = MultiUnit.resource;

// Set the fields to be used when invoking limited results
MultiUnit.limitfields = new Array(
    'listno', 
    'image', 
    'status_tx', 
    'shortsale', 
 ...
 */
MultiUnit.getListing = function(listno, callback){
    this.setHistorical();
 ...
 * @param {function} callback
 */
MultiUnit.getListings = function(offset, callback) {
    this.setHistorical();
